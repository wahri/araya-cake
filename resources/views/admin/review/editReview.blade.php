                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                                    ...
                                                    @foreach ($images as $image)
                                                        <li>
                                                            <input type="radio" name="image_storage_id"
                                                                ...
                                                                {{ $image->id == old('image_storage_id', $review->image_storage_id) ? 'checked' : '' }} />
                                            ...
                                            <div class="tab-pane" id="additional-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ old('name', $review->name) }}" id="name" name="name"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="reviews" name="reviews" rows="5" placeholder="Enter Review">{{ old('reviews', $review->reviews) }}</textarea>
                                                </div>
                                                @error('reviews')
                                                    <small class="text-danger">
                                                        {{ $message }}
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="alt_image">Alt for
                                                                Image</label>
                                                            <input value="{{ old('alt_image', $review->alt_image) }}" id="alt_image"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="link_to_review">Link to
                                                                Review</label>
                                                            <input value="{{ old('link_to_review', $review->link_to_review) }}"
                                                ...
                                                <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                    ...
                                                    <li class="float-end">
                                                        <button type="submit" class="btn btn-primary">
                                                            Update Review <i class="mdi mdi-arrow-right ms-1"></i>
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
