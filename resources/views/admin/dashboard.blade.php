                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item">
                                            <div class="row align-items-center mb-5">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/product/img-5.png') }}" class="img-fluid me-3"
                                                        alt="">
                                                </div>
                                                <div class="col-md-7 offset-md-1">
                                        ...
                                        <div class="carousel-item">
                                            <div class="row align-items-center mb-5">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/product/img-1.png') }}" class="img-fluid me-3"
                                                        alt="">
                                                </div>
                                                <div class="col-md-7 offset-md-1">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>#2356</td>
                                                <td><img src="{{ asset('assets/images/product/img-7.png') }}" width="42"
                                            ...
                                            <tr>
                                                <td>#2564</td>
                                                <td><img src="{{ asset('assets/images/product/img-8.png') }}" width="42"
                                            ...
                                            <tr>
                                                <td>#2125</td>
                                                <td><img src="{{ asset('assets/images/product/img-10.png') }}" width="42"
                                            ...
                                            <tr>
                                                <td>#8587</td>
                                                <td><img src="{{ asset('assets/images/product/img-11.png') }}" width="42"
                                            ...
                                            <tr>
                                                <td>#2354</td>
                                                <td><img src="{{ asset('assets/images/product/img-12.png') }}" width="42"
