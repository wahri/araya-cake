                    ...
                    <div class="col-sm-6">
                        <div class="page-title">
                            ...
                            <ol class="m-0 breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Add Cake</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form action="{{ route('admin.product.store') }}" method="POST">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane" id="product-img">
                                                ...
                                                <p class="card-title-desc">Choose all image for new product</p>
                                                @error('id_images')
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="{{ old('length') }}" id="length" name="length"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="{{ old('width') }}" id="width"
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="{{ old('height') }}" id="height"
                                                ...
                                                <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                    ...
                                                    <li class="float-end">
                                                        <button type="submit" class="btn btn-primary">
                                                            Add Product <i class="mdi mdi-arrow-right ms-1"></i>
                                                        </button>
                                                    </li>
                                                </ul>
                                                <!-- end ul -->
