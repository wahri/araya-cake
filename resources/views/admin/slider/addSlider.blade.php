                                    ...
                                    <form action="{{ route('admin.slider.store') }}" method="POST">
                                        ...
                                        <div class="tab-content twitter-bs-wizard-tab-content">
                                            <div class="tab-pane" id="product-img">
                                                ...
                                                <p class="card-title-desc">Choose image for new slider</p>
                                                @error('image_id')
                                            ...
                                            <div class="tab-pane" id="additional-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="{{ old('big_text') }}" id="big_text"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input value="{{ old('small_text') }}" id="small_text"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ old('alt_image') }}" id="alt_image" name="alt_image"
                                            ...
                                            <div class="tab-pane" id="metadata">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="meta_title">Meta
                                                                title</label>
                                                            <input value="{{ old('meta_title') }}" id="meta_title"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="meta_keyword">Meta
                                                                Keywords</label>
                                                            <input value="{{ old('meta_keyword') }}" id="meta_keyword"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="5"
                                                        placeholder="Enter Description">{{ old('meta_description') }}</textarea>
                                                ...
                                                <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                    ...
                                                    <li class="float-end">
                                                        <button type="submit" class="btn btn-primary">
                                                            Add Slider <i class="mdi mdi-arrow-right ms-1"></i>
                                                        </button>
                                                    </li>
                                                </ul>
                                                <!-- end ul -->
